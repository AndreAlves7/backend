...
class Base64Services
{
    ...
    public function saveFile(String $base64String, String $targetDir, String $nameWithoutExtension, ?String $photoToDelete) : String
    {
        ...
        if($photoToDelete != null && $photoToDelete != ''){
            File::delete($targetDir . '/' . $photoToDelete);
        }
